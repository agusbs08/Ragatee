...
public class CustomBasePDFPagerAdapter extends PagerAdapter {
    ...
    public CustomBasePDFPagerAdapter(Context context, String pdfPath) {
     ...
     */
    public CustomBasePDFPagerAdapter(Context context, String pdfPath, int offScreenSize) {
        this.pdfPath = pdfPath;
        this.context = context;
        this.renderQuality = DEFAULT_QUALITY;
